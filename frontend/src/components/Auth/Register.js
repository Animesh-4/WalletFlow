        ...
        <form className="mt-8 space-y-6" onSubmit={onSubmit}>
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <input id="password" name="password" type={showPassword ? 'text' : 'password'} required minLength="6" value={password} onChange={onChange}
                className="w-full px-4 py-3 text-gray-900 placeholder-gray-500 bg-white/80 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
            ...
            <div className="relative">
              ...
              <input id="confirmPassword" name="confirmPassword" type={showConfirmPassword ? 'text' : 'password'} required value={confirmPassword} onChange={onChange}
                className="w-full px-4 py-3 text-gray-900 placeholder-gray-500 bg-white/80 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
